...
public class MultipleBreaksOptimization {
    ...
    public static void main(String[] args) {
        ...
        // Break 1: 10-minute break every 2 hours
        Break break1 = new Break();
        break1.setMode(0);
        break1.setModeParams(new int[]{300});
        break1.setDuration(600);
        break1.setRepeatsNumber(1);
        breaks.add(break1);

        // Break 2: 30-minute break every 2 hours
        Break break2 = new Break();
        break2.setMode(0);
        break2.setModeParams(new int[]{300});
        break2.setDuration(1800);
        break2.setRepeatsNumber(1);
        breaks.add(break2);

        // Break 3: 10-minute break every 2 hours
        Break break3 = new Break();
        break3.setMode(0);
        break3.setModeParams(new int[]{300});
