...
public class UpdateAddressAttribute {
    ...
    public static void main(String[] args) {
        ...
        Address dataObj = new Address();
        dataObj.setAlias("Modified Alias");
        Routes routes = addressesManager.updateAddressAttribute(routeID, routeDestinationID, dataObj);
        System.out.println(routes.getAddresses().get(0).getAlias());
    }
