...
public class AddAddressToOptimization {
    ...
    public static void main(String[] args) {
        ...
        String optimizationProblemID = responseObject.getOptimization_problem_id();
        ...
        responseObject = addressesManager.addAddressesToOptimizaion(optimizationProblemID, addresses);
        System.out.println();
