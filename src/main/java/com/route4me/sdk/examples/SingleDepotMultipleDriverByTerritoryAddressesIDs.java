 ...
 * @author juan
 */
public class SingleDepotMultipleDriverByTerritoryAddressesIDs {
    ...
    public static void main(String[] args) {
        try {
            ...
            parameters.setRouteName("Single Depot, Multiple Driver - By Address IDs");
            ...
            Territory territory = territoriesManager.getAddressesInTerritory("04F6ADD89DB67371E9008A6688B750C0");
            ...
            Logger.getLogger(SingleDepotMultipleDriverByTerritoryAddressesIDs.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}