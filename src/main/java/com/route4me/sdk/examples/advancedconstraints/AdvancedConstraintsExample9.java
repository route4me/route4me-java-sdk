...
public class AdvancedConstraintsExample9 {
    ...
    public static void main(String[] args) {
        ...
        AddressSource depotFromAddressSource = new AddressSource(0, SourceType.ADDRESSES);
        List<Object> depots = Arrays.asList(depot, depotFromAddressSource);
